...
\begin{lstlisting}
https://github.com/sachinomdubey/Matrix-theory/Assignment4/codes
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/sachinomdubey/Matrix-theory/Assignment4
\end{lstlisting}
\subsection{Problem}
(Section 3.10) 12. Show that:
\begin{align}
    \mydet{1&bc&a(b+c)\\1&ca&b(c+a)\\1&ab&c(a+b)}=0
\end{align}
\subsection{Solution}
Given determinant:
\begin{align}
