...
\end{align}
\\
When the line2 is translated along the vector \vec{n}, it forms a plane. This plane intersects line1 at a single point $c_1$ which is nearest to the line2. Point $c_1$ is given by:
\\
\begin{align}
